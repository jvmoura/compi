...
public class MipsFrame extends Frame {
	...
	public Tree.Expr externalCall(String s, List<Tree.Expr> args) {
		...
		ExpList args_ = new ListConvert<Expr>().listToExpList(args);
		return new Tree.CALL(new Tree.NAME(l), args_);
	}
	...
	public InstrList codegen(StmList stmList)
	{
		...
		while(stmList != null)
		{
			...
			while(instrList != null)
			{
				...
				//System.out.print(instrList.head.format(this));
				//System.out.println("\n");
	...
	private static Tree.MOVE MOVE(Tree.Expr d, Tree.Expr s) {
